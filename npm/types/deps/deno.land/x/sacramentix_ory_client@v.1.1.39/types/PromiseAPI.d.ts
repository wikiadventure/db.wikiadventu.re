...
export declare class PromiseCourierApi {
    private api;
     ...
     */
    getCourierMessage(id: string, _options?: Configuration): Promise<Message>;
    /**
     ...
     */
    listCourierMessages(pageSize?: number, pageToken?: string, status?: CourierMessageStatus, recipient?: string, _options?: Configuration): Promise<Array<Message>>;
}
import { FrontendApiRequestFactory, FrontendApiResponseProcessor } from "../apis/FrontendApi.js";
export declare class PromiseFrontendApi {
    private api;
     ...
     */
    createBrowserLoginFlow(refresh?: boolean, aal?: string, returnTo?: string, cookie?: string, loginChallenge?: string, _options?: Configuration): Promise<LoginFlow>;
    /**
     ...
     */
    createBrowserLogoutFlow(cookie?: string, _options?: Configuration): Promise<LogoutFlow>;
    /**
     ...
     * @param returnTo The URL to return the browser to after the flow was completed.
     */
    createBrowserRecoveryFlow(returnTo?: string, _options?: Configuration): Promise<RecoveryFlow>;
    /**
     ...
     */
    createBrowserRegistrationFlow(returnTo?: string, loginChallenge?: string, afterVerificationReturnTo?: string, _options?: Configuration): Promise<RegistrationFlow>;
    /**
     ...
     * @param cookie HTTP Cookies  When using the SDK in a browser app, on the server side you must include the HTTP Cookie Header sent by the client to your server here. This ensures that CSRF and session cookies are respected.
     */
    createBrowserSettingsFlow(returnTo?: string, cookie?: string, _options?: Configuration): Promise<SettingsFlow>;
    /**
     ...
     * @param returnTo The URL to return the browser to after the flow was completed.
     */
    createBrowserVerificationFlow(returnTo?: string, _options?: Configuration): Promise<VerificationFlow>;
    /**
     ...
     * @param returnTo The URL to return the browser to after the flow was completed.
     */
    createNativeLoginFlow(refresh?: boolean, aal?: string, xSessionToken?: string, returnSessionTokenExchangeCode?: boolean, returnTo?: string, _options?: Configuration): Promise<LoginFlow>;
    /**
     ...
     */
    createNativeRecoveryFlow(_options?: Configuration): Promise<RecoveryFlow>;
    /**
     ...
     * @param returnTo The URL to return the browser to after the flow was completed.
     */
    createNativeRegistrationFlow(returnSessionTokenExchangeCode?: boolean, returnTo?: string, _options?: Configuration): Promise<RegistrationFlow>;
    /**
     ...
     * @param xSessionToken The Session Token of the Identity performing the settings flow.
     */
    createNativeSettingsFlow(xSessionToken?: string, _options?: Configuration): Promise<SettingsFlow>;
    /**
     ...
     */
    createNativeVerificationFlow(_options?: Configuration): Promise<VerificationFlow>;
    /**
     ...
     */
    disableMyOtherSessions(xSessionToken?: string, cookie?: string, _options?: Configuration): Promise<DeleteMySessionsCount>;
    /**
     ...
     * @param cookie Set the Cookie Header. This is especially useful when calling this endpoint from a server-side application. In that scenario you must include the HTTP Cookie Header which originally was included in the request to your server. An example of a session in the HTTP Cookie Header is: &#x60;ory_kratos_session&#x3D;a19iOVAbdzdgl70Rq1QZmrKmcjDtdsviCTZx7m9a9yHIUS8Wa9T7hvqyGTsLHi6Qifn2WUfpAKx9DWp0SJGleIn9vh2YF4A16id93kXFTgIgmwIOvbVAScyrx7yVl6bPZnCx27ec4WQDtaTewC1CpgudeDV2jQQnSaCP6ny3xa8qLH-QUgYqdQuoA_LF1phxgRCUfIrCLQOkolX5nv3ze_f&#x3D;&#x3D;&#x60;.  It is ok if more than one cookie are included here as all other cookies will be ignored.
     */
    disableMySession(id: string, xSessionToken?: string, cookie?: string, _options?: Configuration): Promise<void>;
    /**
     ...
     */
    exchangeSessionToken(initCode: string, returnToCode: string, _options?: Configuration): Promise<SuccessfulNativeLogin>;
    /**
     * This endpoint returns the error associated with a user-facing self service errors.  This endpoint supports stub values to help you implement the error UI:  `?id=stub:500` - returns a stub 500 (Internal Server Error) error.  More information can be found at [Ory Kratos User User Facing Error Documentation](https://www.ory.sh/docs/kratos/self-service/flows/user-facing-errors).
     * Get User-Flow Errors
     * @param id Error is the error\&#39;s ID
     */
    getFlowError(id: string, _options?: Configuration): Promise<FlowError>;
    /**
     ...
     * @param cookie HTTP Cookies  When using the SDK in a browser app, on the server side you must include the HTTP Cookie Header sent by the client to your server here. This ensures that CSRF and session cookies are respected.
     */
    getLoginFlow(id: string, cookie?: string, _options?: Configuration): Promise<LoginFlow>;
    /**
     ...
     * @param cookie HTTP Cookies  When using the SDK in a browser app, on the server side you must include the HTTP Cookie Header sent by the client to your server here. This ensures that CSRF and session cookies are respected.
     */
    getRecoveryFlow(id: string, cookie?: string, _options?: Configuration): Promise<RecoveryFlow>;
    /**
     ...
     * @param cookie HTTP Cookies  When using the SDK in a browser app, on the server side you must include the HTTP Cookie Header sent by the client to your server here. This ensures that CSRF and session cookies are respected.
     */
    getRegistrationFlow(id: string, cookie?: string, _options?: Configuration): Promise<RegistrationFlow>;
    /**
     ...
     * @param cookie HTTP Cookies  When using the SDK in a browser app, on the server side you must include the HTTP Cookie Header sent by the client to your server here. This ensures that CSRF and session cookies are respected.
     */
    getSettingsFlow(id: string, xSessionToken?: string, cookie?: string, _options?: Configuration): Promise<SettingsFlow>;
    /**
     ...
     */
    getVerificationFlow(id: string, cookie?: string, _options?: Configuration): Promise<VerificationFlow>;
    /**
     * This endpoint provides JavaScript which is needed in order to perform WebAuthn login and registration.  If you are building a JavaScript Browser App (e.g. in ReactJS or AngularJS) you will need to load this file:  ```html <script src=\"https://public-kratos.example.org/.well-known/ory/webauthn.js\" type=\"script\" async /> ```  More information can be found at [Ory Kratos User Login](https://www.ory.sh/docs/kratos/self-service/flows/user-login) and [User Registration Documentation](https://www.ory.sh/docs/kratos/self-service/flows/user-registration).
     * Get WebAuthn JavaScript
     */
    getWebAuthnJavaScript(_options?: Configuration): Promise<string>;
    /**
     ...
     * @param cookie Set the Cookie Header. This is especially useful when calling this endpoint from a server-side application. In that scenario you must include the HTTP Cookie Header which originally was included in the request to your server. An example of a session in the HTTP Cookie Header is: &#x60;ory_kratos_session&#x3D;a19iOVAbdzdgl70Rq1QZmrKmcjDtdsviCTZx7m9a9yHIUS8Wa9T7hvqyGTsLHi6Qifn2WUfpAKx9DWp0SJGleIn9vh2YF4A16id93kXFTgIgmwIOvbVAScyrx7yVl6bPZnCx27ec4WQDtaTewC1CpgudeDV2jQQnSaCP6ny3xa8qLH-QUgYqdQuoA_LF1phxgRCUfIrCLQOkolX5nv3ze_f&#x3D;&#x3D;&#x60;.  It is ok if more than one cookie are included here as all other cookies will be ignored.
     */
    listMySessions(perPage?: number, page?: number, xSessionToken?: string, cookie?: string, _options?: Configuration): Promise<Array<Session>>;
    /**
     ...
     */
    performNativeLogout(performNativeLogoutBody: PerformNativeLogoutBody, _options?: Configuration): Promise<void>;
    /**
     ...
     * @param cookie Set the Cookie Header. This is especially useful when calling this endpoint from a server-side application. In that scenario you must include the HTTP Cookie Header which originally was included in the request to your server. An example of a session in the HTTP Cookie Header is: &#x60;ory_kratos_session&#x3D;a19iOVAbdzdgl70Rq1QZmrKmcjDtdsviCTZx7m9a9yHIUS8Wa9T7hvqyGTsLHi6Qifn2WUfpAKx9DWp0SJGleIn9vh2YF4A16id93kXFTgIgmwIOvbVAScyrx7yVl6bPZnCx27ec4WQDtaTewC1CpgudeDV2jQQnSaCP6ny3xa8qLH-QUgYqdQuoA_LF1phxgRCUfIrCLQOkolX5nv3ze_f&#x3D;&#x3D;&#x60;.  It is ok if more than one cookie are included here as all other cookies will be ignored.
     */
    toSession(xSessionToken?: string, cookie?: string, _options?: Configuration): Promise<Session>;
    /**
     ...
     * @param cookie HTTP Cookies  When using the SDK in a browser app, on the server side you must include the HTTP Cookie Header sent by the client to your server here. This ensures that CSRF and session cookies are respected.
     */
    updateLoginFlow(flow: string, updateLoginFlowBody: UpdateLoginFlowBody, xSessionToken?: string, cookie?: string, _options?: Configuration): Promise<SuccessfulNativeLogin>;
    /**
     ...
     * @param cookie HTTP Cookies  When using the SDK in a browser app, on the server side you must include the HTTP Cookie Header sent by the client to your server here. This ensures that CSRF and session cookies are respected.
     */
    updateLogoutFlow(token?: string, returnTo?: string, cookie?: string, _options?: Configuration): Promise<void>;
    /**
     ...
     * @param cookie HTTP Cookies  When using the SDK in a browser app, on the server side you must include the HTTP Cookie Header sent by the client to your server here. This ensures that CSRF and session cookies are respected.
     */
    updateRecoveryFlow(flow: string, updateRecoveryFlowBody: UpdateRecoveryFlowBody, token?: string, cookie?: string, _options?: Configuration): Promise<RecoveryFlow>;
    /**
     ...
     * @param cookie HTTP Cookies  When using the SDK in a browser app, on the server side you must include the HTTP Cookie Header sent by the client to your server here. This ensures that CSRF and session cookies are respected.
     */
    updateRegistrationFlow(flow: string, updateRegistrationFlowBody: UpdateRegistrationFlowBody, cookie?: string, _options?: Configuration): Promise<SuccessfulNativeRegistration>;
    /**
     ...
     * @param cookie HTTP Cookies  When using the SDK in a browser app, on the server side you must include the HTTP Cookie Header sent by the client to your server here. This ensures that CSRF and session cookies are respected.
     */
    updateSettingsFlow(flow: string, updateSettingsFlowBody: UpdateSettingsFlowBody, xSessionToken?: string, cookie?: string, _options?: Configuration): Promise<SettingsFlow>;
    /**
     ...
     * @param cookie HTTP Cookies  When using the SDK in a browser app, on the server side you must include the HTTP Cookie Header sent by the client to your server here. This ensures that CSRF and session cookies are respected.
     */
    updateVerificationFlow(flow: string, updateVerificationFlowBody: UpdateVerificationFlowBody, token?: string, cookie?: string, _options?: Configuration): Promise<VerificationFlow>;
}
import { IdentityApiRequestFactory, IdentityApiResponseProcessor } from "../apis/IdentityApi.js";
export declare class PromiseIdentityApi {
    private api;
     ...
     */
    batchPatchIdentities(patchIdentitiesBody?: PatchIdentitiesBody, _options?: Configuration): Promise<BatchPatchIdentitiesResponse>;
    /**
     * Create an [identity](https://www.ory.sh/docs/kratos/concepts/identity-user-model).  This endpoint can also be used to [import credentials](https://www.ory.sh/docs/kratos/manage-identities/import-user-accounts-identities) for instance passwords, social sign in configurations or multifactor methods.
     * Create an Identity
     * @param createIdentityBody
     */
    createIdentity(createIdentityBody?: CreateIdentityBody, _options?: Configuration): Promise<Identity>;
    /**
     * This endpoint creates a recovery code which should be given to the user in order for them to recover (or activate) their account.
     * Create a Recovery Code
     * @param createRecoveryCodeForIdentityBody
     */
    createRecoveryCodeForIdentity(createRecoveryCodeForIdentityBody?: CreateRecoveryCodeForIdentityBody, _options?: Configuration): Promise<RecoveryCodeForIdentity>;
    /**
     * This endpoint creates a recovery link which should be given to the user in order for them to recover (or activate) their account.
     * Create a Recovery Link
     * @param createRecoveryLinkForIdentityBody
     */
    createRecoveryLinkForIdentity(createRecoveryLinkForIdentityBody?: CreateRecoveryLinkForIdentityBody, _options?: Configuration): Promise<RecoveryLinkForIdentity>;
    /**
     * Calling this endpoint irrecoverably and permanently deletes the [identity](https://www.ory.sh/docs/kratos/concepts/identity-user-model) given its ID. This action can not be undone. This endpoint returns 204 when the identity was deleted or when the identity was not found, in which case it is assumed that is has been deleted already.
     * Delete an Identity
     * @param id ID is the identity\&#39;s ID.
     */
    deleteIdentity(id: string, _options?: Configuration): Promise<void>;
    /**
     ...
     */
    deleteIdentityCredentials(id: string, type: 'totp' | 'webauthn' | 'lookup', _options?: Configuration): Promise<Identity>;
    /**
     * Calling this endpoint irrecoverably and permanently deletes and invalidates all sessions that belong to the given Identity.
     * Delete & Invalidate an Identity\'s Sessions
     * @param id ID is the identity\&#39;s ID.
     */
    deleteIdentitySessions(id: string, _options?: Configuration): Promise<void>;
    /**
     * Calling this endpoint deactivates the specified session. Session data is not deleted.
     * Deactivate a Session
     * @param id ID is the session\&#39;s ID.
     */
    disableSession(id: string, _options?: Configuration): Promise<void>;
    /**
     * Calling this endpoint extends the given session ID. If `session.earliest_possible_extend` is set it will only extend the session after the specified time has passed.  Retrieve the session ID from the `/sessions/whoami` endpoint / `toSession` SDK method.
     * Extend a Session
     * @param id ID is the session\&#39;s ID.
     */
    extendSession(id: string, _options?: Configuration): Promise<Session>;
    /**
     ...
     */
    getIdentity(id: string, includeCredential?: Array<'password' | 'totp' | 'oidc' | 'webauthn' | 'lookup_secret'>, _options?: Configuration): Promise<Identity>;
    /**
     * Return a specific identity schema.
     * Get Identity JSON Schema
     * @param id ID must be set to the ID of schema you want to get
     */
    getIdentitySchema(id: string, _options?: Configuration): Promise<any>;
    /**
     ...
     */
    getSession(id: string, expand?: Array<string>, _options?: Configuration): Promise<Session>;
    /**
     ...
     */
    listIdentities(perPage?: number, page?: number, credentialsIdentifier?: string, _options?: Configuration): Promise<Array<Identity>>;
    /**
     ...
     * @param page Pagination Page  This value is currently an integer, but it is not sequential. The value is not the page number, but a reference. The next page can be any number and some numbers might return an empty list.  For example, page 2 might not follow after page 1. And even if page 3 and 5 exist, but page 4 might not exist.
     */
    listIdentitySchemas(perPage?: number, page?: number, _options?: Configuration): Promise<Array<IdentitySchemaContainer>>;
    /**
     ...
     */
    listIdentitySessions(id: string, perPage?: number, page?: number, active?: boolean, _options?: Configuration): Promise<Array<Session>>;
    /**
     ...
     */
    listSessions(pageSize?: number, pageToken?: string, active?: boolean, expand?: Array<string>, _options?: Configuration): Promise<Array<Session>>;
    /**
     ...
     * @param jsonPatch
     */
    patchIdentity(id: string, jsonPatch?: Array<JsonPatch>, _options?: Configuration): Promise<Identity>;
    /**
     ...
     */
    updateIdentity(id: string, updateIdentityBody?: UpdateIdentityBody, _options?: Configuration): Promise<Identity>;
}
import { JwkApiRequestFactory, JwkApiResponseProcessor } from "../apis/JwkApi.js";
export declare class PromiseJwkApi {
    private api;
     ...
     */
    createJsonWebKeySet(set: string, createJsonWebKeySet: CreateJsonWebKeySet, _options?: Configuration): Promise<JsonWebKeySet>;
    /**
     ...
     */
    deleteJsonWebKey(set: string, kid: string, _options?: Configuration): Promise<void>;
    /**
     * Use this endpoint to delete a complete JSON Web Key Set and all the keys in that set.  A JSON Web Key (JWK) is a JavaScript Object Notation (JSON) data structure that represents a cryptographic key. A JWK Set is a JSON data structure that represents a set of JWKs. A JSON Web Key is identified by its set and key id. ORY Hydra uses this functionality to store cryptographic keys used for TLS and JSON Web Tokens (such as OpenID Connect ID tokens), and allows storing user-defined keys as well.
     * Delete JSON Web Key Set
     * @param set The JSON Web Key Set
     */
    deleteJsonWebKeySet(set: string, _options?: Configuration): Promise<void>;
    /**
     ...
     */
    getJsonWebKey(set: string, kid: string, _options?: Configuration): Promise<JsonWebKeySet>;
    /**
     * This endpoint can be used to retrieve JWK Sets stored in ORY Hydra.  A JSON Web Key (JWK) is a JavaScript Object Notation (JSON) data structure that represents a cryptographic key. A JWK Set is a JSON data structure that represents a set of JWKs. A JSON Web Key is identified by its set and key id. ORY Hydra uses this functionality to store cryptographic keys used for TLS and JSON Web Tokens (such as OpenID Connect ID tokens), and allows storing user-defined keys as well.
     * Retrieve a JSON Web Key Set
     * @param set JSON Web Key Set ID
     */
    getJsonWebKeySet(set: string, _options?: Configuration): Promise<JsonWebKeySet>;
    /**
     ...
     * @param jsonWebKey
     */
    setJsonWebKey(set: string, kid: string, jsonWebKey?: JsonWebKey, _options?: Configuration): Promise<JsonWebKey>;
    /**
     * Use this method if you do not want to let Hydra generate the JWKs for you, but instead save your own.  A JSON Web Key (JWK) is a JavaScript Object Notation (JSON) data structure that represents a cryptographic key. A JWK Set is a JSON data structure that represents a set of JWKs. A JSON Web Key is identified by its set and key id. ORY Hydra uses this functionality to store cryptographic keys used for TLS and JSON Web Tokens (such as OpenID Connect ID tokens), and allows storing user-defined keys as well.
     ...
     * @param jsonWebKeySet
     */
    setJsonWebKeySet(set: string, jsonWebKeySet?: JsonWebKeySet, _options?: Configuration): Promise<JsonWebKeySet>;
}
...
export declare class PromiseOAuth2Api {
     ...
     */
    acceptOAuth2ConsentRequest(consentChallenge: string, acceptOAuth2ConsentRequest?: AcceptOAuth2ConsentRequest, _options?: Configuration): Promise<OAuth2RedirectTo>;
    /**
     ...
     */
    acceptOAuth2LoginRequest(loginChallenge: string, acceptOAuth2LoginRequest?: AcceptOAuth2LoginRequest, _options?: Configuration): Promise<OAuth2RedirectTo>;
    /**
     * When a user or an application requests Ory OAuth 2.0 to remove the session state of a subject, this endpoint is used to confirm that logout request.  The response contains a redirect URL which the consent provider should redirect the user-agent to.
     * Accept OAuth 2.0 Session Logout Request
     * @param logoutChallenge OAuth 2.0 Logout Request Challenge
     */
    acceptOAuth2LogoutRequest(logoutChallenge: string, _options?: Configuration): Promise<OAuth2RedirectTo>;
    /**
     * Create a new OAuth 2.0 client. If you pass `client_secret` the secret is used, otherwise a random secret is generated. The secret is echoed in the response. It is not possible to retrieve it later on.
     * Create OAuth 2.0 Client
     * @param oAuth2Client OAuth 2.0 Client Request Body
     */
    createOAuth2Client(oAuth2Client: OAuth2Client, _options?: Configuration): Promise<OAuth2Client>;
    /**
     * Delete an existing OAuth 2.0 Client by its ID.  OAuth 2.0 clients are used to perform OAuth 2.0 and OpenID Connect flows. Usually, OAuth 2.0 clients are generated for applications which want to consume your OAuth 2.0 or OpenID Connect capabilities.  Make sure that this endpoint is well protected and only callable by first-party components.
     * Delete OAuth 2.0 Client
     * @param id The id of the OAuth 2.0 Client.
     */
    deleteOAuth2Client(id: string, _options?: Configuration): Promise<void>;
    /**
     * This endpoint deletes OAuth2 access tokens issued to an OAuth 2.0 Client from the database.
     * Delete OAuth 2.0 Access Tokens from specific OAuth 2.0 Client
     * @param clientId OAuth 2.0 Client ID
     */
    deleteOAuth2Token(clientId: string, _options?: Configuration): Promise<void>;
    /**
     * Use this endpoint to delete trusted JWT Bearer Grant Type Issuer. The ID is the one returned when you created the trust relationship.  Once deleted, the associated issuer will no longer be able to perform the JSON Web Token (JWT) Profile for OAuth 2.0 Client Authentication and Authorization Grant.
     * Delete Trusted OAuth2 JWT Bearer Grant Type Issuer
     * @param id The id of the desired grant
     */
    deleteTrustedOAuth2JwtGrantIssuer(id: string, _options?: Configuration): Promise<void>;
    /**
     * Get an OAuth 2.0 client by its ID. This endpoint never returns the client secret.  OAuth 2.0 clients are used to perform OAuth 2.0 and OpenID Connect flows. Usually, OAuth 2.0 clients are generated for applications which want to consume your OAuth 2.0 or OpenID Connect capabilities.
     * Get an OAuth 2.0 Client
     * @param id The id of the OAuth 2.0 Client.
     */
    getOAuth2Client(id: string, _options?: Configuration): Promise<OAuth2Client>;
    /**
     * When an authorization code, hybrid, or implicit OAuth 2.0 Flow is initiated, Ory asks the login provider to authenticate the subject and then tell Ory now about it. If the subject authenticated, he/she must now be asked if the OAuth 2.0 Client which initiated the flow should be allowed to access the resources on the subject\'s behalf.  The consent challenge is appended to the consent provider\'s URL to which the subject\'s user-agent (browser) is redirected to. The consent provider uses that challenge to fetch information on the OAuth2 request and then tells Ory if the subject accepted or rejected the request.  The default consent provider is available via the Ory Managed Account Experience. To customize the consent provider, please head over to the OAuth 2.0 documentation.
     * Get OAuth 2.0 Consent Request
     * @param consentChallenge OAuth 2.0 Consent Request Challenge
     */
    getOAuth2ConsentRequest(consentChallenge: string, _options?: Configuration): Promise<OAuth2ConsentRequest>;
    /**
     * When an authorization code, hybrid, or implicit OAuth 2.0 Flow is initiated, Ory asks the login provider to authenticate the subject and then tell the Ory OAuth2 Service about it.  Per default, the login provider is Ory itself. You may use a different login provider which needs to be a web-app you write and host, and it must be able to authenticate (\"show the subject a login screen\") a subject (in OAuth2 the proper name for subject is \"resource owner\").  The authentication challenge is appended to the login provider URL to which the subject\'s user-agent (browser) is redirected to. The login provider uses that challenge to fetch information on the OAuth2 request and then accept or reject the requested authentication process.
     * Get OAuth 2.0 Login Request
     * @param loginChallenge OAuth 2.0 Login Request Challenge
     */
    getOAuth2LoginRequest(loginChallenge: string, _options?: Configuration): Promise<OAuth2LoginRequest>;
    /**
     * Use this endpoint to fetch an Ory OAuth 2.0 logout request.
     * Get OAuth 2.0 Session Logout Request
     * @param logoutChallenge
     */
    getOAuth2LogoutRequest(logoutChallenge: string, _options?: Configuration): Promise<OAuth2LogoutRequest>;
    /**
     * Use this endpoint to get a trusted JWT Bearer Grant Type Issuer. The ID is the one returned when you created the trust relationship.
     * Get Trusted OAuth2 JWT Bearer Grant Type Issuer
     * @param id The id of the desired grant
     */
    getTrustedOAuth2JwtGrantIssuer(id: string, _options?: Configuration): Promise<TrustedOAuth2JwtGrantIssuer>;
    /**
     ...
     */
    introspectOAuth2Token(token: string, scope?: string, _options?: Configuration): Promise<IntrospectedOAuth2Token>;
    /**
     ...
     */
    listOAuth2Clients(pageSize?: number, pageToken?: string, clientName?: string, owner?: string, _options?: Configuration): Promise<Array<OAuth2Client>>;
    /**
     ...
     */
    listOAuth2ConsentSessions(subject: string, pageSize?: number, pageToken?: string, loginSessionId?: string, _options?: Configuration): Promise<Array<OAuth2ConsentSession>>;
    /**
     ...
     */
    listTrustedOAuth2JwtGrantIssuers(maxItems?: number, defaultItems?: number, issuer?: string, _options?: Configuration): Promise<Array<TrustedOAuth2JwtGrantIssuer>>;
    /**
     * Use open source libraries to perform OAuth 2.0 and OpenID Connect available for any programming language. You can find a list of libraries at https://oauth.net/code/  The Ory SDK is not yet able to this endpoint properly.
     * OAuth 2.0 Authorize Endpoint
     */
    oAuth2Authorize(_options?: Configuration): Promise<void>;
    /**
     ...
     * @param refreshToken
     */
    oauth2TokenExchange(grantType: string, clientId?: string, code?: string, redirectUri?: string, refreshToken?: string, _options?: Configuration): Promise<OAuth2TokenExchange>;
    /**
     ...
     */
    patchOAuth2Client(id: string, jsonPatch: Array<JsonPatch>, _options?: Configuration): Promise<OAuth2Client>;
    /**
     ...
     */
    rejectOAuth2ConsentRequest(consentChallenge: string, rejectOAuth2Request?: RejectOAuth2Request, _options?: Configuration): Promise<OAuth2RedirectTo>;
    /**
     ...
     * @param rejectOAuth2Request
     */
    rejectOAuth2LoginRequest(loginChallenge: string, rejectOAuth2Request?: RejectOAuth2Request, _options?: Configuration): Promise<OAuth2RedirectTo>;
    /**
     * When a user or an application requests Ory OAuth 2.0 to remove the session state of a subject, this endpoint is used to deny that logout request. No HTTP request body is required.  The response is empty as the logout provider has to chose what action to perform next.
     * Reject OAuth 2.0 Session Logout Request
     * @param logoutChallenge
     */
    rejectOAuth2LogoutRequest(logoutChallenge: string, _options?: Configuration): Promise<void>;
    /**
     ...
     */
    revokeOAuth2ConsentSessions(subject: string, client?: string, all?: boolean, _options?: Configuration): Promise<void>;
    /**
     ...
     */
    revokeOAuth2LoginSessions(subject?: string, sid?: string, _options?: Configuration): Promise<void>;
    /**
     ...
     * @param clientSecret
     */
    revokeOAuth2Token(token: string, clientId?: string, clientSecret?: string, _options?: Configuration): Promise<void>;
    /**
     ...
     * @param oAuth2Client OAuth 2.0 Client Request Body
     */
    setOAuth2Client(id: string, oAuth2Client: OAuth2Client, _options?: Configuration): Promise<OAuth2Client>;
    /**
     ...
     */
    setOAuth2ClientLifespans(id: string, oAuth2ClientTokenLifespans?: OAuth2ClientTokenLifespans, _options?: Configuration): Promise<OAuth2Client>;
    /**
     * Use this endpoint to establish a trust relationship for a JWT issuer to perform JSON Web Token (JWT) Profile for OAuth 2.0 Client Authentication and Authorization Grants [RFC7523](https://datatracker.ietf.org/doc/html/rfc7523).
     * Trust OAuth2 JWT Bearer Grant Type Issuer
     * @param trustOAuth2JwtGrantIssuer
     */
    trustOAuth2JwtGrantIssuer(trustOAuth2JwtGrantIssuer?: TrustOAuth2JwtGrantIssuer, _options?: Configuration): Promise<TrustedOAuth2JwtGrantIssuer>;
}
import { OidcApiRequestFactory, OidcApiResponseProcessor } from "../apis/OidcApi.js";
export declare class PromiseOidcApi {
    private api;
     ...
     */
    createOidcDynamicClient(oAuth2Client: OAuth2Client, _options?: Configuration): Promise<OAuth2Client>;
    /**
     ...
     * @param id The id of the OAuth 2.0 Client.
     */
    deleteOidcDynamicClient(id: string, _options?: Configuration): Promise<void>;
    /**
     * A mechanism for an OpenID Connect Relying Party to discover the End-User\'s OpenID Provider and obtain information needed to interact with it, including its OAuth 2.0 endpoint locations.  Popular libraries for OpenID Connect clients include oidc-client-js (JavaScript), go-oidc (Golang), and others. For a full list of clients go here: https://openid.net/developers/certified/
     * OpenID Connect Discovery
     */
    discoverOidcConfiguration(_options?: Configuration): Promise<OidcConfiguration>;
    /**
     ...
     * @param id The id of the OAuth 2.0 Client.
     */
    getOidcDynamicClient(id: string, _options?: Configuration): Promise<OAuth2Client>;
    /**
     * This endpoint returns the payload of the ID Token, including `session.id_token` values, of the provided OAuth 2.0 Access Token\'s consent request.  In the case of authentication error, a WWW-Authenticate header might be set in the response with more information about the error. See [the spec](https://datatracker.ietf.org/doc/html/rfc6750#section-3) for more details about header format.
     * OpenID Connect Userinfo
     */
    getOidcUserInfo(_options?: Configuration): Promise<OidcUserInfo>;
    /**
     * This endpoint initiates and completes user logout at the Ory OAuth2 & OpenID provider and initiates OpenID Connect Front- / Back-channel logout:  https://openid.net/specs/openid-connect-frontchannel-1_0.html https://openid.net/specs/openid-connect-backchannel-1_0.html  Back-channel logout is performed asynchronously and does not affect logout flow.
     * OpenID Connect Front- and Back-channel Enabled Logout
     */
    revokeOidcSession(_options?: Configuration): Promise<void>;
    /**
     ...
     * @param oAuth2Client OAuth 2.0 Client Request Body
     */
    setOidcDynamicClient(id: string, oAuth2Client: OAuth2Client, _options?: Configuration): Promise<OAuth2Client>;
}
import { PermissionApiRequestFactory, PermissionApiResponseProcessor } from "../apis/PermissionApi.js";
export declare class PromisePermissionApi {
    private api;
     ...
     * @param maxDepth
     */
    checkPermission(namespace?: string, object?: string, relation?: string, subjectId?: string, subjectSetNamespace?: string, subjectSetObject?: string, subjectSetRelation?: string, maxDepth?: number, _options?: Configuration): Promise<CheckPermissionResult>;
    /**
     * To learn how relationship tuples and the check works, head over to [the documentation](https://www.ory.sh/docs/keto/concepts/api-overview).
     * Check a permission
     * @param namespace Namespace of the Relationship
     ...
     * @param maxDepth
     */
    checkPermissionOrError(namespace?: string, object?: string, relation?: string, subjectId?: string, subjectSetNamespace?: string, subjectSetObject?: string, subjectSetRelation?: string, maxDepth?: number, _options?: Configuration): Promise<CheckPermissionResult>;
    /**
     ...
     * @param maxDepth
     */
    expandPermissions(namespace: string, object: string, relation: string, maxDepth?: number, _options?: Configuration): Promise<ExpandedPermissionTree>;
    /**
     * To learn how relationship tuples and the check works, head over to [the documentation](https://www.ory.sh/docs/keto/concepts/api-overview).
     * Check a permission
     * @param maxDepth
     ...
     */
    postCheckPermission(maxDepth?: number, postCheckPermissionBody?: PostCheckPermissionBody, _options?: Configuration): Promise<CheckPermissionResult>;
    /**
     * To learn how relationship tuples and the check works, head over to [the documentation](https://www.ory.sh/docs/keto/concepts/api-overview).
     * Check a permission
     ...
     */
    postCheckPermissionOrError(maxDepth?: number, postCheckPermissionOrErrorBody?: PostCheckPermissionOrErrorBody, _options?: Configuration): Promise<CheckPermissionResult>;
}
import { ProjectApiRequestFactory, ProjectApiResponseProcessor } from "../apis/ProjectApi.js";
export declare class PromiseProjectApi {
    private api;
     ...
     */
    createProject(createProjectBody?: CreateProjectBody, _options?: Configuration): Promise<Project>;
    /**
     ...
     */
    createProjectApiKey(project: string, createProjectApiKeyRequest?: CreateProjectApiKeyRequest, _options?: Configuration): Promise<ProjectApiKey>;
    /**
     ...
     */
    deleteProjectApiKey(project: string, tokenId: string, _options?: Configuration): Promise<void>;
    /**
     * Use this API to get your active project in the Ory Network Console UI.
     * Returns the Ory Network Project selected in the Ory Network Console
     */
    getActiveProjectInConsole(_options?: Configuration): Promise<ActiveProjectInConsole>;
    /**
     * Get a projects you have access to by its ID.
     * Get a Project
     * @param projectId Project ID  The project\&#39;s ID.
     */
    getProject(projectId: string, _options?: Configuration): Promise<Project>;
    /**
     * This endpoint requires the user to be a member of the project with the role `OWNER` or `DEVELOPER`.
     * Get all members associated with this project
     * @param projectId Project ID  The project\&#39;s ID.
     */
    getProjectMembers(projectId: string, _options?: Configuration): Promise<Array<CloudAccount>>;
    /**
     ...
     */
    getProjectMetrics(projectId: string, eventType: string, resolution: string, _from: Date, to: Date, _options?: Configuration): Promise<GetProjectMetricsResponse>;
    /**
     * A list of all the project\'s API tokens.
     * List a project\'s API Tokens
     * @param project The Project ID or Project slug
     */
    listProjectApiKeys(project: string, _options?: Configuration): Promise<Array<ProjectApiKey>>;
    /**
     * Lists all projects you have access to.
     * List All Projects
     */
    listProjects(_options?: Configuration): Promise<Array<ProjectMetadata>>;
    /**
     ...
     * @param jsonPatch
     */
    patchProject(projectId: string, jsonPatch?: Array<JsonPatch>, _options?: Configuration): Promise<SuccessfulProjectUpdate>;
    /**
     * !! Use with extreme caution !!  Using this API endpoint you can purge (completely delete) a project and its data. This action can not be undone and will delete ALL your data.  !! Use with extreme caution !!
     * Irrecoverably purge a project
     * @param projectId Project ID  The project\&#39;s ID.
     */
    purgeProject(projectId: string, _options?: Configuration): Promise<void>;
    /**
     ...
     */
    removeProjectMember(projectId: string, memberId: string, _options?: Configuration): Promise<void>;
    /**
     * Use this API to set your active project in the Ory Network Console UI.
     * Sets the Ory Network Project active in the Ory Network Console
     * @param setActiveProjectInConsoleBody
     */
    setActiveProjectInConsole(setActiveProjectInConsoleBody?: SetActiveProjectInConsoleBody, _options?: Configuration): Promise<void>;
    /**
     ...
     * @param setProject
     */
    setProject(projectId: string, setProject?: SetProject, _options?: Configuration): Promise<SuccessfulProjectUpdate>;
}
import { RelationshipApiRequestFactory, RelationshipApiResponseProcessor } from "../apis/RelationshipApi.js";
export declare class PromiseRelationshipApi {
    private api;
     ...
     * @param body
     */
    checkOplSyntax(body?: string, _options?: Configuration): Promise<CheckOplSyntaxResult>;
    /**
     * Use this endpoint to create a relationship.
     * Create a Relationship
     * @param createRelationshipBody
     */
    createRelationship(createRelationshipBody?: CreateRelationshipBody, _options?: Configuration): Promise<Relationship>;
    /**
     ...
     * @param subjectSetRelation Relation of the Subject Set
     */
    deleteRelationships(namespace?: string, object?: string, relation?: string, subjectId?: string, subjectSetNamespace?: string, subjectSetObject?: string, subjectSetRelation?: string, _options?: Configuration): Promise<void>;
    /**
     ...
     * @param subjectSetRelation Relation of the Subject Set
     */
    getRelationships(pageToken?: string, pageSize?: number, namespace?: string, object?: string, relation?: string, subjectId?: string, subjectSetNamespace?: string, subjectSetObject?: string, subjectSetRelation?: string, _options?: Configuration): Promise<Relationships>;
    /**
     * Get all namespaces
     * Query namespaces
     */
    listRelationshipNamespaces(_options?: Configuration): Promise<RelationshipNamespaces>;
    /**
     * Use this endpoint to patch one or more relationships.
     * Patch Multiple Relationships
     * @param relationshipPatch
     */
    patchRelationships(relationshipPatch?: Array<RelationshipPatch>, _options?: Configuration): Promise<void>;
}
import { WellknownApiRequestFactory, WellknownApiResponseProcessor } from "../apis/WellknownApi.js";
export declare class PromiseWellknownApi {
    private api;
     ...
     */
    discoverJsonWebKeys(_options?: Configuration): Promise<JsonWebKeySet>;
}
