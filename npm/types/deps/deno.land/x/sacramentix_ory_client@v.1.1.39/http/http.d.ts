 ...
 */
export type HttpFile = dntShim.Blob & {
...
export declare class SelfDecodingBody implements ResponseBody {
    private dataSource;
    constructor(dataSource: Promise<dntShim.Blob>);
    binary(): Promise<dntShim.Blob>;
    text(): Promise<string>;
}
export declare class ResponseContext {
     ...
     */
    getBodyAsAny(): Promise<string | dntShim.Blob | undefined>;
}
